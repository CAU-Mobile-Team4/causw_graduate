...
import 'package:causw_graduate/GraduateProvider/Requirement/Detail/MajorCredit/Year24MajorCredit.dart';
...
class Year24GraduateReq extends GraduateReq {
  @override
  String studentInfo = '24학번 주전공';

  Year24GraduateReq() {
    totalCredit = Year19TotalCredit();
    minGrade = NotApplicateCondition();
    majorCredit = Year24MajorCredit();
